...
BarnesHut.Description = 'O(n log n) Barnes–Hut gravitational simulation with quadtree visualization. Press Space to play/pause, R to reset, Q to toggle quadtree, T to toggle trails.';
